      ...
      `}</style>
            ...
            >
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto h-screen grid grid-cols-1 md:grid-cols-2">
                    ...
                    {/* Left Content */}
<div
  className="flex flex-col justify-center px-6 md:px-12 py-20"
...
>
  ...
  <button
    onClick={handleClick}
    className="inline-flex items-center gap-2 bg-white text-black hover:bg-black hover:text-white font-normal px-4 py-2 shadow-lg transition duration-300 w-36 justify-center"
  >
                    ...
                    <div className="h-full w-full relative overflow-hidden">
                        {images.map((img, index) => (
                            <img
                                ...
                                src={img}
                                alt={`Slide ${index + 1}`}
                                className={`absolute top-0 left-0 w-full h-full object-cover transition-opacity duration-2000 ease-in-out ${index === currentIndex ? "opacity-100" : "opacity-0"
                                    }`}
